...
namespace CyUSB
{
    ...
    public enum FX3_FWDWNLOAD_ERROR_CODE { SUCCESS = 0, FAILED, INVALID_MEDIA_TYPE, INVALID_FWSIGNATURE, DEVICE_CREATE_FAILED, INCORRECT_IMAGE_LENGTH, INVALID_FILE, SPILASH_ERASE_FAILED, CORRUPT_FIRMWARE_IMAGE_FILE, EXCEED_IMAGE_LENGTH, I2CE2PROM_UNKNOWN_I2C_SIZE };
