/*
 ## Cypress CyUSB3 driver header file (cyusb30_def.h)
 ## =======================================================
 ##
...
//constant defination
	typedef struct _USB_BOS_DESCRIPTOR
	{
		...
		USHORT wToatalLength;/* Total length of descriptor ( icluding device capability*/
	...
	typedef struct _USB_BOS_USB20_DEVICE_EXTENSION
	{
		...
		unsigned int bmAttribute;// Bitmap encoding for supprted feature and  Link power managment supprted if set
