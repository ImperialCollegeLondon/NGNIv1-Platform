    ...
    public class DXElement : FrameworkElement, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty RendererProperty =
            ...
            new PropertyMetadata((d, e) => ((DXElement)d).OnRendererChanged((IDirect3D)e.OldValue, (IDirect3D)e.NewValue)));
                //new PropertyMetadata((d, e) => ((DXElement)d).OnRendererChanged((DependencyObject)d, (DependencyPropertyChangedEventArgs)e)));
        ...
        //private void OnRendererChanged(DependencyObject sender, DependencyPropertyChangedEventArgs arg)
        {
            //if (newValue != null)
            //{
                UpdateSize();
